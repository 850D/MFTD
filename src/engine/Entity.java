 ...
 * 
 * Copyright (C) 2012 Florian Stötzel, Mark Arendt, Kai Burchardt, Dominik
 * 
...
{	
	 ...
	 * unscaled entity with no rotation at 0,0
	...
	public Entity addComponent(Component component) {
		// Checks if we have a renderComponent to declare 
	...
	/** 
	 * Decorates the entity with a new component
	 * and adds a type identifier.
	 * 
	 * The component must be a child of the 
	 * abstract component class. 
	 * 
	 * @param component A {@link engine.components.Component Component} instance
	 * @param type		The corresponding  {@link engine.components.Component#CompTypes CompType}
	 */
	public Entity addComponent(Component component, Component.CompTypes type) {
		if (RenderComponent.class.isInstance(component))

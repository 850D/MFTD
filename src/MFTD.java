...
public class MFTD extends BasicGame 
{
    ...
    public void init(GameContainer gc) throws SlickException {
        ...
        //bgMap.setType(Entity.CompTypes.RENDER);
        ...
        .addComponent(new RightLeftMovement("PlayerMovement"))
        .setPosition(new Vector2f(100, 350));        
    }
